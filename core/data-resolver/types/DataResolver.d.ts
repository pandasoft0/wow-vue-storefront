...
declare namespace DataResolver {
  ...
  interface UserService {
    ...
    getMessages: (idOrder: number) => Promise<Task>,
    addMessage: (idOrder:number, idUser:number, user: string, date: string, message: string) => Promise<Task>,
  ...
  interface ReviewsService {
    ...
    listReview: (productId: number) => Promise<Task>
  }
