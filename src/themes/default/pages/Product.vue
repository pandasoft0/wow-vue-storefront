<template>
  <div id="product">
    <div class="container">
      <div class="in_hdr  no-mobile">
        <a href="/" class="a_logo">
        <img width="auto" height="80px" class="logomainpage" src="/assets/_WoW_logo_white.svg">
        </a>
    ...
    <section class="bg-cl-secondary px20 product-top-section">
      <div class="container">
        <section class="row m0 between-xs">
          <div class="col-xs-12 col-md-4 center-xs middle-xs image">
            <product-gallery
          ...
          <div class="col-xs-12 col-md-7 data">
            ...
            >
              {{ $t('Code Service: {sku}', { sku: getCurrentProduct.sku }) }}
            </div>
            ...
            <product-custom-options
              v-show="getCurrentProduct.custom_options && getCurrentProduct.custom_options.length > 0 && currentUser"
              :product="getCurrentProduct"
            />
            ...
            <a
              ...
              class="center-xs no-outline button-full block brdr-none w-100 px10 py20 bg-cl-mine-shaft :bg-cl-th-secondary ripple weight-400 h4 cl-white sans-serif fs-medium col-xs-12 col-sm-4 col-md-6"
            >{{ $t('Login to your account') }}</a>
            <div class="error" v-show="currentUser && !getCurrentProduct.custom_options">* The total price is formed according to provided  service.</div>
            <div class="row m0" v-show="currentUser">
                <add-to-cart
                  :product="getCurrentProduct"
    ...
    <section class="container px15 pt50 pb35 cl-accent details">
      ...
      <div class="h4 details-wrapper" :class="{'details-wrapper--open': detailsOpen}">
        <div class="row between-md m0">
          <div class="col-xs-12 col-sm-6 cst-description">
            <div class="lh30 h5 pdnew20" v-html="getCurrentProduct.description" />
          </div>
