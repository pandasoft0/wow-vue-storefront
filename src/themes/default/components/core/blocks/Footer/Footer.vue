<template>
  <footer :class="{ 'brdr-top-1 brdr-cl-secondary': isCheckoutPage }">
    <div v-if="!isCheckoutPage" class="footer-links flex bg-cl-secondary">
      <div class="row m0 col-lg-4 col-md-4 col-xs-12 start-md between-md between-xs no-mobile">
        <div class="in_hdr">
          <img width="auto" height="100px" class="logomainpage" src="/assets/_WoW_logo_white.svg">
          <div class="in_hdr_bg"></div>
        </div>
      </div>
      <div class="row m0 col-lg-4 col-md-4 col-xs-12 start-md between-md between-xs no-mobile center-xs">
        <div class="wt100 center-xs">
        ...
        <div class="wt100 center-xs">
          <router-link class="cl-secondary" :to="getLinkFor('/contact-us')" exact>
            {{ $t('Contact us') }}
          </router-link>
        </div>

      </div>
      <div class="row m0 col-lg-4 col-md-4 col-xs-12 social mt20 center-xs">
        <div>
        <a
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" class="facebook icon" width="40" height="40" viewBox="0 0 40 40" fill="#38D0C3">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" class="instagram icon" width="40" height="40" viewBox="0 0 40 40" fill="#38D0C3">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" class="pinterest icon" width="40" height="40" viewBox="0 0 40 40" fill="#38D0C3">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" class="youtube icon" width="40" height="40" viewBox="0 0 40 40" fill="#38D0C3">
