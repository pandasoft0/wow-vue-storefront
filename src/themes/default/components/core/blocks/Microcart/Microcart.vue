<template>
  ...
  >
    ...
    <div v-if="productsInCart.length" class="summary px40 cl-accent serif">
      <h3 class="m0 pt20 mb15 weight-400 summary-heading">
        {{ $t('Shopping summary') }}
      </h3>
      ...
      <div class="row pt10 pb10 weight-700 middle-xs" v-for="(segment, index) in totals" :key="index" v-if="segment.code === 'grand_total'">
